    ...
    <div>
      <div>
        {lineChartData && lineChartOptions && (
          <Line data={lineChartData} options={lineChartOptions} width={400} height={400}/>
        )}
      </div>
      <div>
        <Doughnut data={doughnutChartData} options={doughnutChartOptions} width={400} height={400}/>
      </div>
    </div>
  );
};
