    ...
    <div>
      <div>
        {lineChartData && lineChartOptions && (
          <Line data={lineChartData} options={lineChartOptions} width={4000} height={2000}/>
        )}
      </div>
      <div>
        <Doughnut data={doughnutChartData} options={doughnutChartOptions} width={4000} height={2000}/>
      </div>
    </div>
  );
};
