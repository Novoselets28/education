...
import { Chart as ChartJS, ArcElement, Tooltip, Legend, CategoryScale, LinearScale, Title, LineElement, PointElement, TimeScale } from 'chart.js'; // Include TimeScale
...
// eslint-disable-next-line max-len
ChartJS.register(ArcElement, Tooltip, Legend, CategoryScale, LinearScale, Title, LineElement, PointElement, TimeScale); // Register TimeScale
    ...
    const chartOptions = {
      ...
      scales: {
        x: {
          ...
          time: {
            unit: 'month' // Display labels by month
          }
        },
        y: {
          title: {
