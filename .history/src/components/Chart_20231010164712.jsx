    ...
    <div>
      <div width={400} height={200}>
        {lineChartData && lineChartOptions && (
          <Line data={lineChartData} options={lineChartOptions} width={400} height={2000}/>
        )}
      </div>
      <div width={400} height={200}>
        <Doughnut data={doughnutChartData} options={doughnutChartOptions} width={400} height={2000}/>
      </div>
    </div>
  );
};
